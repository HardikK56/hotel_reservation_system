...
class Cust_Win:
    def __init__(self,root):
        ...
        # mother name
        labelmname=Label(labelframeleft,text="Mother Name:",font=("arial",12,"bold"),padx=2,pady=6)
        labelmname.grid(row=2,column=0,sticky=W)
        ...
        textPostCode=ttk.Entry(labelframeleft,textvariable=self.var_post,width=29,font=("arial",13,"bold"))
